app.controller("lectureController",["$scope", "$sce", "$rootScope", "dataService", "$filter", "$state", "$interval", "$stateParams", function($scope, $sce, $rootScope, dataService, $filter, $state, $interval, $stateParams){
