app.controller("lectureController", ["$scope", "$rootScope", "dataService", "$filter", "$state", "$interval", "$stateParams", "$modal", function ($scope, $rootScope, dataService, $filter, $state, $interval, $stateParams, $modal) {
